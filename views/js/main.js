...
function updatePositions() {
  ...
  for (var i = 0; i <40; i++) { //changed items.length to 40 since it's constant
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // Changed i<200 to i<40 since it appears the maximum number of pizzas in the background is 5 rows of 8 pizzas
  for (var i = 0; i <40; i++) {
